...
```
<plugin name="cordova-plugin-ios-permissions" spec="https://github.com/xpertsoft009/cordova-plugin-ios-permission.git#v1.1.1" source="git" />
```
